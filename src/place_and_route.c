...
printf ("O valor de fixed_channel_width e: %d.\n\n",router_opts.fixed_channel_width);
 ...
 if (router_opts.fixed_channel_width == NO_FIXED_CHANNEL_WIDTH) {
    ...
    printf("O valor de width_fac e: %d.", width_fac);
...
printf("O valor de current e: %d.\n\n",current);
printf("O valor de MAX_CHANNEL_WIDTH e: %d.",MAX_CHANNEL_WIDTH); 
    ...
    printf("O valor de success e: %d.",success);
